...
if(isset($_POST['talent']) && !isset($display_case)){
 $name="Talentprenuership";
...
if(isset($_POST['Career']) && !isset($display_case)){
 $name="Career";
 $username=htmlspecialchars($_POST['username']);
...
if(isset($_POST['Entreprenuership']) && !isset($display_case)){
...
if(isset($_POST['Volunteerism']) && !isset($display_case)){
 $name="Volunteerism";
 $username=htmlspecialchars($_POST['username']);
 ...
 <div class="card-container">
     <div class="section-card talent-card">
         <div class="card-info">
             ...
             <p class="center-align">
               ...
               <input type="submit"   class="btn white black-text" name="talent" value="ENTER CHAT ROOM">
             </p>
             <br><br><br>
         </div>
     ...
     <div class="section-card career-card">
         <div class="card-info">
             ...
             <p class="center-align">
              <input type="hidden" name="username" value="<?php echo  $_SESSION['user_id'];  ?>">
               <input type="submit"   class="btn white black-text" name="Career" value="ENTER CHAT ROOM">
             </p>
             <br><br><br>
         </div>
         <div class="random-chat-section">
     ...
     <div class="section-card entrep-card">
         <div class="card-info">
             ...
             <p class="center-align">
           <input type="hidden" name="username" value="<?php echo  $_SESSION['user_id'];  ?>">
               <input type="submit"   class="btn white black-text" name="Entreprenuership" value="ENTER CHAT ROOM">
             </p>
             <br><br><br>
         </div>
         <div class="random-chat-section">
     ...
     <div class="section-card volunteer-card">
         <div class="card-info">
             ...
             <p class="center-align">
         <input type="hidden" name="username" value="<?php echo  $_SESSION['user_id'];  ?>">
               <input type="submit"   class="btn white black-text" name="Volunteerism" value="ENTER CHAT ROOM">
             </p>
             <br><br><br>
         </div>
         <div class="random-chat-section">
